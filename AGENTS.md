...
- **GitHub attribution** (issues/PRs/reviews): Add footer with tool and model:
  `🤖 Generated by [TOOL_NAME](TOOL_URL) - [MODEL_NAME]`
  - Tools: Claude Code, Droid, Amp Code, Cursor, Copilot, etc.
  - Models: Sonnet 4.5, Opus 4.5, Gemini 2.5 Pro, GPT 4.1, GLM 4.7, MiniMax M2.1, etc.
